    ...
    @else
        ...
        @else
            ...
            <table class="table table-bordered align-middle">
                <thead class="table-light">
                    <tr>
                        ...
                        <th width="280">Số lượng & Cập nhật</th>
                ...
                <tbody>
                    @foreach($products as $product)
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('client.cart.update') }}" method="POST" class="d-flex gap-2 m-0">
                                    @csrf
                                    <input type="number"
                            ...
                            <td>
                                <form action="{{ route('client.cart.remove', $product->id) }}" method="POST" class="m-0">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="d-flex justify-content-between">
                ...
                <form action="{{ route('client.cart.clear') }}" method="POST" class="m-0">
                    @csrf
                    @method('DELETE')
