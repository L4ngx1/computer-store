...
@section('title', 'MSI PS Series - Danh mục sản phẩm')
...
<div class="container py-4">
    <div class="w-100 mb-4 text-white p-5 d-flex align-items-center justify-content-between position-relative overflow-hidden style-top-banner" 
        ...
        <div class="z-1">
            ...
            <h2 class="fw-bold m-0" style="font-size: 22px;">HIỆU NĂNG CAO VỚI MỨC GIÁ HỢP LÝ</h2>
        </div>
    ...
    <div class="small text-secondary mb-3" style="font-size: 12px;">
        Trang chủ <span class="mx-1">›</span> Laptop <span class="mx-1">›</span> <span class="text-dark">MSI PS Series</span>
    </div>
    ...
    <div class="row g-4">
        <div class="col-lg-3">
            <div class="border p-3 bg-white mb-3">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <span class="fw-bold text-dark small text-uppercase">Bộ lọc</span>
                    <button class="btn btn-sm btn-light border rounded-pill px-3" style="font-size: 11px;">Xóa bộ lọc</button>
                </div>

                <div class="mb-4">
                    <p class="fw-bold small text-dark mb-2 border-bottom pb-1">Danh mục</p>
                    <ul class="list-unstyled small d-flex flex-column gap-2 text-secondary">
                        <li class="d-flex justify-content-between"><span>PC ĐẶT TRƯỚC</span> <span class="badge bg-light text-dark border">15</span></li>
                ...
                <div class="mb-4">
                    <p class="fw-bold small text-dark mb-2 border-bottom pb-1">Khoảng giá</p>
                    <ul class="list-unstyled small d-flex flex-column gap-2 text-secondary">
                ...
                <div class="mb-3">
                    <p class="fw-bold small text-dark mb-2 border-bottom pb-1">Thương hiệu</p>
            ...
            <div class="bg-dark text-white p-4 text-center rounded-1 position-relative overflow-hidden style-sidebar-ad" style="min-height: 250px;">
                <h5 class="fw-bold mb-2 text-warning">DÒNG SẢN PHẨM ICON</h5>
                <p class="small text-secondary">Trở nên khác biệt</p>
        ...
        <div class="col-lg-9">
            <div class="d-flex justify-content-between align-items-center bg-light p-2 border mb-4 rounded-1 small text-secondary">
                <div>Hiển thị 1-5 trên 20 sản phẩm</div>
                <div class="d-flex align-items-center gap-3">
                    <div class="d-flex align-items-center gap-1">
                        <span>Sắp xếp:</span>
                        <select class="form-select form-select-sm border bg-white" style="font-size: 12px; width: 120px;">
            ...
            <div class="d-flex flex-column gap-3">
                ...
                <div class="row g-0 border p-3 align-items-center bg-white style-product-row position-relative">
                    <span class="position-absolute text-success small" style="top: 15px; right: 20px; font-size: 11px;">● Còn hàng</span>
