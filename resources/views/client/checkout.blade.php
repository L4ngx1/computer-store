                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="last_name" name="last_name"
                                        value="{{ old('last_name', Auth::user()->name ? substr(strstr(Auth::user()->name, ' '), 1) : '') }}"
                                        required>
                                </div>
                                <div class="col-12">
                        ...
                        <div class="card-body p-2">
                            <div class="list-group list-group-flush">
                                <label
                                    ...
                                    <div>
                                        <input class="form-check-input me-2" type="radio" name="shipping" value="standard"
                                            checked>
                            ...
                            <div class="list-group list-group-flush">
                                <label class="list-group-item list-group-item-action d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <small class="d-block text-muted">Thanh toán bằng tiền mặt khi shipper giao
                                            hàng.</small>
                                    </div>
                                </label>
                            </div>
                                ...
                                @forelse($cartItems as $item)
                                    <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{Storage::url($item->product->thumbnail) ? $item->product->thumbnail : 'https://via.placeholder.com/60' }}"
                                        ...
                                        <span
                                            class="fw-bold small">{{ number_format(($item->product->sale_price ?? $item->product->price) * $item->quantity, 0, ',', '.') }}đ</span>
                                    </div>
                                @empty
